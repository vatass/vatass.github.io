# Vasiliki Tassopoulou - Personal Academic Website

This repository contains the source code for my personal academic website, built using Jekyll and the Minimal Light theme.

## Website Structure

The website is organized as follows:

- `index.md`: Main content of the homepage
- `_includes/`: Contains modular sections of the website
  - `publications.md`: Publications section
  - `services.md`: Academic services and mentorship section
  - `skills.md`: Technical skills section
  - `projects.md`: Detailed project descriptions
  - `contact.md`: Contact information and availability
- `_data/`: Contains data files
  - `publications.yml`: Publication data in YAML format
- `assets/`: Contains static assets
  - `css/`: CSS stylesheets
  - `img/`: Images
  - `files/`: PDF files (CV, papers, etc.)
...
1. Edit `_data/publications.yml` and add a new entry following the existing format
2. The publications will automatically appear in the Publications section

#### Updating Personal Information

1. Edit `_config.yml` to update basic information like title, position, and links
2. Edit `index.md` to update the About Me section

#### Adding/Updating Projects

1. Edit `_includes/projects.md` to add or update project information

#### Updating Skills

1. Edit `_includes/skills.md` to update your skills and expertise
...
This website is based on the [Minimal Light](https://github.com/yaoyao-liu/minimal-light) theme by Yaoyao Liu, with custom modifications.
